...
class OnboardingActivity : AppCompatActivity() {
    ...
    // Dynamic, context-matching animated emoji for each step. Step 3 uses a
    // cute, pleading face with glossy/watery eyes instead of a plain
    // lock-and-key icon, per the onboarding spec.
    private fun setUpOnboardingEmojis() {
        findViewById<EmojiView>(R.id.ivOnboardingSlide1Emoji).setEmoji("⚡")
        findViewById<EmojiView>(R.id.ivOnboardingSlide2Emoji).setEmoji("🔋")
        findViewById<EmojiView>(R.id.ivOnboardingSlide3Emoji).setEmoji("🥺")
    }
